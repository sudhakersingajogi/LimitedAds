...
{{add_deal_fail_msg}}
        ...
        <form class="form-horizontal" role="form" name="form.adddeal" ng-submit="addadeal(add_deal_mdl,'add')" novalidate>
         ...
         <div class="form-group">
            ...
            <input class="form-control" type="file" file-model="Myfile" name="Myfile" onchange="angular.element(this).scope().imageUpload(event,'merchant_deal_pics')" multiple >
             <span ng-hide="dealpics_selected"  ng-cloak>{{dealpic_message}}</span>
             
             <span ng-show="invalidimage_type"  ng-cloak>Invalid image type</span>
            </div>
          </div>
