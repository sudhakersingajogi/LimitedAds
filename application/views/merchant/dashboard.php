...
<table class="table table-condensed " >
    ...
    <tbody>
      ...
      <tr ng-repeat="deals in dealsoffered.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage))" ng-cloak>
         <td>{{deals.SLNO}}</td>
        ...
        <td>
        <a href="#viewOffer" data-toggle="modal" class="btn btn-sm btn-primary" ng-click="viewprinteddeal(deals.Deal_Id)" > View</a>
