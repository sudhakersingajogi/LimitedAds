...
{{add_deal_fail_msg}}
 ...
 <div ng-init="get_edit_printed_offer_deal('<?PHP echo $this->uri->segment(3); ?>','add_printed_deal')"> 
 
        <form class="form-horizontal" role="form" name="form.editdeal" ng-submit="addprintdeal(edit_deal_mdl,'edit')" novalidate >
          ...
          <div class="form-group" >
            ...
            <div class="col-lg-8">
             <select name="addsize" class="form-control" ng-options="option.size for option in sizeslist.available_sizes track by option.sizeid" ng-model="edit_deal_mdl.addsize" ng-change="checkdealsize(edit_deal_mdl.addsize)" required >
