    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#MerchantRegister" ng-click="resetmerchant_reg()">Merchant</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           <li><a href="javascript:void(0)" data-toggle="modal" data-target="#MerchantLogin" ng-click="resetmerchant_login()">Merchant</a></li>
